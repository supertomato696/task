...
@BaseInspector.register('道路边界交叉检测')
class DetectIntersectBoundary(BaseLineInespector):
    ...
    def inspect(self):
        ...
        lines, intersect_pts = LineProcessor.check_line_intersection(self.boundary_gdf)
