...
@BaseInspector.register('车道线折角检测')
class InspectZigzagLaneline(BaseLineInespector):
    ...
    def inspect(self):
        ...
        self.result['折角异常车道线'] = lg_threhold_result
        self.result['符合要求车道线'] = sq_threhold_result
