...
@BaseInspector.register('车道线前驱后继关系检测')
class DetectPredecessorSuccessorLaneline(BaseLineInespector):
    ...
    def inspect(self):
        ...
        for idx, row in self.lanelines_gdf.iterrows():
            ...
            # 验证前驱关系
            validate_ret = LineProcessor.validate_relation(self.lanelines_gdf,
                                                           line,
                                                           present_id,
