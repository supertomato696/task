...
inline bool PositionObject_ObjectType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PositionObject_ObjectType* value) {
...
inline bool PositionObject_ObjectSubType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PositionObject_ObjectSubType* value) {
...
class PositionObject final :
 ...
 public:
  ...
  ~PositionObject() override;
  explicit constexpr PositionObject(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static inline bool ObjectSubType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      ObjectSubType* value) {
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Polygon* release_border();
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Circle* release_circle();
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Polyline* release_pole();
...
inline ::RoadPB::Polygon* PositionObject::mutable_border() {
  ::RoadPB::Polygon* _msg = _internal_mutable_border();
...
inline ::RoadPB::Circle* PositionObject::mutable_circle() {
  ::RoadPB::Circle* _msg = _internal_mutable_circle();
...
inline void PositionObject::set_allocated_circle(::RoadPB::Circle* circle) {
  ...
  if (circle) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(circle));
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::Polyline* PositionObject::mutable_pole() {
  ::RoadPB::Polyline* _msg = _internal_mutable_pole();
...
inline void PositionObject::set_allocated_pole(::RoadPB::Polyline* pole) {
  ...
  if (pole) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(pole));
    if (message_arena != submessage_arena) {
...
void PositionObject::set_content(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
inline ::RoadPB::FeatureID* PositionObject::add_lane_groups() {
  ::RoadPB::FeatureID* _add = _internal_add_lane_groups();
