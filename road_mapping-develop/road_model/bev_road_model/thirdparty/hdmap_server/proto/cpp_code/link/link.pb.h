...
class Link final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::FeatureID* release_snode_id();
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::FeatureID* release_enode_id();
...
class Node final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Point* release_geom();
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::FeatureID* release_junction_id();
...
inline ::RoadPB::FeatureID* Link::mutable_snode_id() {
  ::RoadPB::FeatureID* _msg = _internal_mutable_snode_id();
...
inline void Link::set_allocated_snode_id(::RoadPB::FeatureID* snode_id) {
  ...
  if (snode_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(snode_id));
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::FeatureID* Link::mutable_enode_id() {
  ::RoadPB::FeatureID* _msg = _internal_mutable_enode_id();
...
inline void Link::set_allocated_enode_id(::RoadPB::FeatureID* enode_id) {
  ...
  if (enode_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(enode_id));
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::LangName* Link::add_names() {
  ::RoadPB::LangName* _add = _internal_add_names();
...
inline ::RoadPB::FeatureID* Link::add_forward_groups() {
  ::RoadPB::FeatureID* _add = _internal_add_forward_groups();
...
inline ::RoadPB::FeatureID* Link::add_backward_groups() {
  ::RoadPB::FeatureID* _add = _internal_add_backward_groups();
...
inline ::RoadPB::Point* Node::mutable_geom() {
  ::RoadPB::Point* _msg = _internal_mutable_geom();
...
inline ::RoadPB::FeatureID* Node::add_link_ids() {
  ::RoadPB::FeatureID* _add = _internal_add_link_ids();
...
inline ::RoadPB::FeatureID* Node::mutable_junction_id() {
  ::RoadPB::FeatureID* _msg = _internal_mutable_junction_id();
