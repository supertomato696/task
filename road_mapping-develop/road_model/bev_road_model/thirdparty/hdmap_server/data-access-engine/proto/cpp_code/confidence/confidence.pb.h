...
class DataQuality PROTOBUF_FINAL :
 ...
 public:
  ...
  inline DataQuality* New() const final {
    return CreateMaybeMessage<DataQuality>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_confidence_2fconfidence_2eproto);
    return ::descriptor_table_confidence_2fconfidence_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::RoadPB::FeatureID* release_feat_id();
...
inline ::RoadPB::FeatureID* DataQuality::release_feat_id() {
  auto temp = unsafe_arena_release_feat_id();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::RoadPB::FeatureID* DataQuality::mutable_feat_id() {
  ...
  return _internal_mutable_feat_id();
}
inline void DataQuality::set_allocated_feat_id(::RoadPB::FeatureID* feat_id) {
  ...
  if (feat_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(feat_id)->GetArena();
    if (message_arena != submessage_arena) {
