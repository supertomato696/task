...
void protobuf_AssignDesc_sofa_2fpbrpc_2frpc_5fmeta_2eproto() {
  ...
  static const int RpcMeta_offsets_[9] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RpcMeta, server_timeout_),
...
const int RpcMeta::kServerTimeoutFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 100: {
        ...
        if (input->ExpectTag(808)) goto parse_server_timeout;
        break;
      }
...
void RpcMeta::MergeFrom(const RpcMeta& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_server_timeout()) {
      set_server_timeout(from.server_timeout());
    }
    if (from.has_failed()) {
...
void RpcMeta::Swap(RpcMeta* other) {
  if (other != this) {
    ...
    std::swap(server_timeout_, other->server_timeout_);
