...
// int RoadModelProcBindTrail2::get_poss_cross_point_mutil(RoadModelSessionData* session) {
//     // 定义缓冲区范围，用于判断车道线的宽度
...
// int RoadModelProcBindTrail2::sort_new_lc(RoadModelSessionData* session) {
//     // 遍历所有生成的车道中心特征
...
// int RoadModelProcBindTrail2::get_poss_cross_fls(RoadModelSessionData* session) {
...
// int RoadModelProcBindTrail2::search_nearest_crosswalk(RoadModelSessionData* session,
//         KeyPose* poss, std::vector<RoadObjectInfo*> &secs) {
//     float radius = FLAGS_bind_trail_pos_match_crosswalk_radius2;
...
// int RoadModelProcBindTrail2::search_nearest_fls(RoadModelSessionData* session,
...
// int RoadModelProcBindTrail2::search_nearest_lc(RoadModelSessionData* session,
...
// int RoadModelProcBindTrail2::search_nearest_pos(RoadModelSessionData* session,
...
// }
// 
// KeyPose* RoadModelProcBindTrail2::get_lane_segment(RoadModelSessionData* session,
//         LaneCenterFeature* lc, std::vector<KeyPose*> &secs) {
