...
namespace fsdmap
{
    namespace road_model
    {
        ...
        private:
            // 0: 车道线有重复的矢量化
            int export_to_shape_file_with_vectorize0(RoadModelSessionData *session);
            int export_lane_boundary_to_shp_vectorize0(RoadModelSessionData *session);
            int export_lane_center_to_shp_vectorize0(RoadModelSessionData *session);
            int export_road_boundary_to_shp_vectorize0(RoadModelSessionData *session);
            int export_stop_line_to_shp_vectorize0(RoadModelSessionData *session);
            int export_cross_walk_to_shp_vectorize0(RoadModelSessionData *session);
            int export_road_mark_to_shp_vectorize0(RoadModelSessionData *session);
            int export_intersection_to_shp_vectorize0(RoadModelSessionData *session);

            // 1：车道线去重的矢量化
            int export_to_shape_file_with_vectorize1(RoadModelSessionData *session);
            int export_lane_boundary_to_shp_vectorize1(RoadModelSessionData *session, int flag = 0);
            int export_lane_center_to_shp_vectorize1(RoadModelSessionData *session);
            int export_road_boundary_to_shp_vectorize1(RoadModelSessionData *session, int flag = 0);
            int export_stop_line_to_shp_vectorize1(RoadModelSessionData *session);
            int export_cross_walk_to_shp_vectorize1(RoadModelSessionData *session);
            int export_road_mark_to_shp_vectorize1(RoadModelSessionData *session);
            int export_intersection_to_shp_vectorize1(RoadModelSessionData *session);
