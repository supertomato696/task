...
public:
    ...
    virtual int download_ground_pcd(std::vector<std::shared_ptr<KeyPose>> &key_poses, 
            bool is_lass=false) = 0;
    ...
    virtual int download_link_mnt(std::vector<std::shared_ptr<KeyPoseLine>> &link_list,
            std::vector<std::shared_ptr<KeyPose>> &link_point_list) = 0;        

    virtual int download_intersection(std::vector<std::shared_ptr<Intersection>> &inter_list) = 0;

    virtual int download_intersection_mnt(std::vector<std::shared_ptr<Intersection>> &inter_list) = 0;

    virtual int download_feature(std::vector<std::shared_ptr<Feature>> &feature_list) = 0;

    virtual int download_feature_mnt(std::vector<std::shared_ptr<Feature>> &feature_list) = 0;

    virtual int download_lane_line(std::vector<std::shared_ptr<Feature>> &feature_vec) = 0;

    virtual int download_lane_line_mmt(std::vector<std::shared_ptr<Feature>> &feature_vec) = 0;
    ...
    virtual int download_boundary_line_mnt(std::vector<std::shared_ptr<Feature>> &feature_vec) = 0;
    ...
    virtual int download_object_mmt(std::vector<std::shared_ptr<RoadObjectInfo>> &raw_object_list) = 0;
    ...
    virtual int download_junction_mmt(std::vector<std::shared_ptr<JunctionInfo>> &raw_junction_list, 
        std::vector<std::shared_ptr<ImpassableAreaInfo>> &raw_area_list) = 0;
    ...
    virtual int download_match_info(std::vector<std::shared_ptr<LinkInfo>> & link_info_ptr,std::vector<LinkInfo*> & link_info)=0;
...
public:
    ...
    virtual int download_intersection_mnt(std::vector<std::shared_ptr<Intersection>> &inter_list);

    virtual int download_feature(std::vector<std::shared_ptr<Feature>> &feature_vec);

    virtual int download_feature_mnt(std::vector<std::shared_ptr<Feature>> &feature_vec);

    virtual int download_lane_line(std::vector<std::shared_ptr<Feature>> &feature_vec);

    virtual int download_lane_line_mmt(std::vector<std::shared_ptr<Feature>> &feature_vec);
    ...
    virtual int download_boundary_line_mnt(std::vector<std::shared_ptr<Feature>> &feature_vec);
    ...
    virtual int download_object_mmt(std::vector<std::shared_ptr<RoadObjectInfo>> &raw_object_list);
    ...
    virtual int download_junction_mmt(std::vector<std::shared_ptr<JunctionInfo>> &raw_junction_list, 
     ...
     virtual   int download_match_info(std::vector<std::shared_ptr<LinkInfo>> & link_info_ptr,std::vector<LinkInfo*> & link_info);

    virtual int upload_road_info(std::string &data) {};

    bool search_nearest_pose(pcl::PointXYZI& searchPt);
