...
inline bool ProvinceCode_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ProvinceCode* value) {
...
class LangName final :
 ...
 public:
  ...
  ~LangName() override;
  explicit constexpr LangName(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void set_name_type(ArgT0&& arg0, ArgT... args);
  std::string* mutable_name_type();
  PROTOBUF_MUST_USE_RESULT std::string* release_name_type();
  void set_allocated_name_type(std::string* name_type);
  private:
  const std::string& _internal_name_type() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_name_type(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_lang_code(ArgT0&& arg0, ArgT... args);
  std::string* mutable_lang_code();
  PROTOBUF_MUST_USE_RESULT std::string* release_lang_code();
  void set_allocated_lang_code(std::string* lang_code);
  private:
  const std::string& _internal_lang_code() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_lang_code(const std::string& value);
...
class Polygon final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Point* release_normal();
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Point* release_orientation();
...
class Circle final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Point* release_center();
...
class Cylinder final :
 ...
 public:
  ...
  ~Cylinder() override;
  explicit constexpr Cylinder(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class BoundingBox final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Point* release_min_pt();
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::Point* release_max_pt();
...
class RangeAttribute final :
 ...
 public:
  ...
  ~RangeAttribute() override;
  explicit constexpr RangeAttribute(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::AttributeValue* release_start_val();
  ...
  PROTOBUF_MUST_USE_RESULT ::RoadPB::AttributeValue* release_end_val();
...
class FixedSpeedLimit final :
 ...
 public:
  ...
  ~FixedSpeedLimit() override;
  explicit constexpr FixedSpeedLimit(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class CondSpeedLimit final :
 ...
 public:
  ...
  ~CondSpeedLimit() override;
  explicit constexpr CondSpeedLimit(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void LangName::set_name_type(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 name_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:RoadPB.LangName.name_type)
}
inline std::string* LangName::mutable_name_type() {
  std::string* _s = _internal_mutable_name_type();
...
inline void LangName::_internal_set_name_type(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  name_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* LangName::_internal_mutable_name_type() {
  _has_bits_[0] |= 0x00000001u;
  return name_type_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* LangName::release_name_type() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return name_type_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LangName::set_lang_code(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 lang_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void LangName::_internal_set_lang_code(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  lang_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* LangName::_internal_mutable_lang_code() {
  _has_bits_[0] |= 0x00000002u;
  return lang_code_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* LangName::release_lang_code() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return lang_code_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LangName::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
...
inline ::RoadPB::Point* Polyline::add_pts() {
  ::RoadPB::Point* _add = _internal_add_pts();
...
inline ::RoadPB::Point* Polygon::mutable_normal() {
  ::RoadPB::Point* _msg = _internal_mutable_normal();
...
inline void Polygon::set_allocated_normal(::RoadPB::Point* normal) {
  ...
  if (normal) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::RoadPB::Point>::GetOwningArena(normal);
...
inline ::RoadPB::Point* Polygon::mutable_orientation() {
  ::RoadPB::Point* _msg = _internal_mutable_orientation();
...
inline void Polygon::set_allocated_orientation(::RoadPB::Point* orientation) {
  ...
  if (orientation) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::RoadPB::Point>::GetOwningArena(orientation);
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::Point* Circle::mutable_center() {
  ::RoadPB::Point* _msg = _internal_mutable_center();
...
inline void Circle::set_allocated_center(::RoadPB::Point* center) {
  ...
  if (center) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::RoadPB::Point>::GetOwningArena(center);
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::Point* Cylinder::add_points() {
  ::RoadPB::Point* _add = _internal_add_points();
...
inline ::RoadPB::Point* BoundingBox::mutable_min_pt() {
  ::RoadPB::Point* _msg = _internal_mutable_min_pt();
...
inline void BoundingBox::set_allocated_min_pt(::RoadPB::Point* min_pt) {
  ...
  if (min_pt) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::RoadPB::Point>::GetOwningArena(min_pt);
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::Point* BoundingBox::mutable_max_pt() {
  ::RoadPB::Point* _msg = _internal_mutable_max_pt();
...
inline void BoundingBox::set_allocated_max_pt(::RoadPB::Point* max_pt) {
  ...
  if (max_pt) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::RoadPB::Point>::GetOwningArena(max_pt);
    if (message_arena != submessage_arena) {
...
inline void RangeAttribute::set_allocated_geom(::RoadPB::Polyline* geom) {
  ...
  if (geom) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::RoadPB::Polyline>::GetOwningArena(geom);
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::AttributeValue* RangeAttribute::_internal_mutable_start_val() {
  ...
  if (start_val_ == nullptr) {
    auto* p = CreateMaybeMessage<::RoadPB::AttributeValue>(GetArenaForAllocation());
    start_val_ = p;
  }
  return start_val_;
}
inline ::RoadPB::AttributeValue* RangeAttribute::mutable_start_val() {
  ::RoadPB::AttributeValue* _msg = _internal_mutable_start_val();
...
inline void RangeAttribute::set_allocated_start_val(::RoadPB::AttributeValue* start_val) {
  ...
  if (start_val) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::RoadPB::AttributeValue>::GetOwningArena(start_val);
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::AttributeValue* RangeAttribute::mutable_end_val() {
  ::RoadPB::AttributeValue* _msg = _internal_mutable_end_val();
...
inline void RangeAttribute::set_allocated_end_val(::RoadPB::AttributeValue* end_val) {
  ...
  if (end_val) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::RoadPB::AttributeValue>::GetOwningArena(end_val);
    if (message_arena != submessage_arena) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void FixedSpeedLimit::set_valid_period(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void FixedSpeedLimit::set_vehicle_type(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CondSpeedLimit::set_valid_period(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 valid_period_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CondSpeedLimit::set_vehicle_type(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 vehicle_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
