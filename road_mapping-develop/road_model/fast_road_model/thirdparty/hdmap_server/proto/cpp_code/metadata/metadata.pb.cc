...
struct FeatureIDDefaultTypeInternal {
  constexpr FeatureIDDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT FeatureIDDefaultTypeInternal _FeatureID_default_instance_;
}  // namespace RoadPB
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_metadata_2fmetadata_2eproto = {
  false, false, 311, descriptor_table_protodef_metadata_2fmetadata_2eproto, "metadata/metadata.proto", 
  &descriptor_table_metadata_2fmetadata_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_metadata_2fmetadata_2eproto::offsets,
  file_level_metadata_metadata_2fmetadata_2eproto, file_level_enum_descriptors_metadata_2fmetadata_2eproto, file_level_service_descriptors_metadata_2fmetadata_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_metadata_2fmetadata_2eproto_getter() {
  return &descriptor_table_metadata_2fmetadata_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_metadata_2fmetadata_2eproto(&descriptor_table_metadata_2fmetadata_2eproto);
namespace RoadPB {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&tileid_) - reinterpret_cast<char*>(this)),
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData FeatureID::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    FeatureID::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*FeatureID::GetClassData() const { return &_class_data_; }

void FeatureID::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<FeatureID *>(to)->MergeFrom(
      static_cast<const FeatureID &>(from));
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FeatureID::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_metadata_2fmetadata_2eproto_getter, &descriptor_table_metadata_2fmetadata_2eproto_once,
      file_level_metadata_metadata_2fmetadata_2eproto[0]);
}
