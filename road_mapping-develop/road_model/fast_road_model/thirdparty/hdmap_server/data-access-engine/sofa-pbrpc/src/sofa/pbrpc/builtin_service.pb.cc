...
void protobuf_AssignDesc_sofa_2fpbrpc_2fbuiltin_5fservice_2eproto() {
  ...
  static const int ServerOptions_offsets_[8] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ServerOptions, max_connection_count_),
  };
...
void protobuf_AddDesc_sofa_2fpbrpc_2fbuiltin_5fservice_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\t:\003all\022\032\n\016period_seconds\030\002 \001(\003:\00260\"a\n\014St"
    "atResponse\0226\n\rservice_stats\030\001 \003(\0132\037.sofa"
    ".pbrpc.builtin.ServiceStat\022\031\n\021server_sta"
    "rt_time\030\002 \001(\t2\310\004\n\016BuiltinService\022O\n\006Heal"
    "th\022!.sofa.pbrpc.builtin.HealthRequest\032\"."
    "sofa.pbrpc.builtin.HealthResponse\022d\n\rSer"
    "verOptions\022(.sofa.pbrpc.builtin.ServerOp"
    "tionsRequest\032).sofa.pbrpc.builtin.Server"
    "OptionsResponse\022d\n\rUpdateOptions\022(.sofa."
    "pbrpc.builtin.UpdateOptionsRequest\032).sof"
    "a.pbrpc.builtin.UpdateOptionsResponse\022a\n"
    "\014ServerStatus\022\'.sofa.pbrpc.builtin.Serve"
    "rStatusRequest\032(.sofa.pbrpc.builtin.Serv"
    "erStatusResponse\022d\n\013ListService\022&.sofa.p"
    "brpc.builtin.ListServiceRequest\032\'.sofa.p"
    "brpc.builtin.ListServiceResponse\"\004\220\342\t\001\022I"
    "\n\004Stat\022\037.sofa.pbrpc.builtin.StatRequest\032"
    " .sofa.pbrpc.builtin.StatResponse\032\005\200\342\t\270\027"
    "B\t\200\001\001\210\001\001\220\001\001", 2171);
...
const int ServerOptions::kMaxConnectionCountFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_max_connection_count;
        break;
      }
      ...
      case 8: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_max_connection_count:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int64, ::google::protobuf::internal::WireFormatLite::TYPE_INT64>(
                 input, &max_connection_count_)));
...
void ServerOptions::SerializeWithCachedSizes(
  ...
  // optional int64 max_connection_count = 8;
  if (has_max_connection_count()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(8, this->max_connection_count(), output);
  }
...
::google::protobuf::uint8* ServerOptions::SerializeWithCachedSizesToArray(
  ...
  // optional int64 max_connection_count = 8;
  if (has_max_connection_count()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(8, this->max_connection_count(), target);
  }
...
void ServerOptions::MergeFrom(const ServerOptions& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_max_connection_count()) {
      set_max_connection_count(from.max_connection_count());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void ServerOptions::Swap(ServerOptions* other) {
  if (other != this) {
    ...
    std::swap(max_connection_count_, other->max_connection_count_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
