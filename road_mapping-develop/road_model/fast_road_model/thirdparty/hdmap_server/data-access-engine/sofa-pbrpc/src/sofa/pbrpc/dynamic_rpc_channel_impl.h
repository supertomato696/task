...
class DynamicRpcChannelImpl : public RpcChannelImpl,
    public ::std::enable_shared_from_this<DynamicRpcChannelImpl>
{
public:
...
private:
    ...
    typedef ::std::shared_ptr<ServerContext> ServerContextPtr;
