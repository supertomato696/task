...
class PositionObjectDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PositionObject> _instance;
} _PositionObject_default_instance_;
}  // namespace RoadPB
static void InitDefaultsscc_info_PositionObject_position_2fposition_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::RoadPB::_PositionObject_default_instance_;
    new (ptr) ::RoadPB::PositionObject();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::RoadPB::PositionObject::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<4> scc_info_PositionObject_position_2fposition_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 4, 0, InitDefaultsscc_info_PositionObject_position_2fposition_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_position_2fposition_2eproto_sccs[1] = {
  &scc_info_PositionObject_position_2fposition_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_position_2fposition_2eproto = {
  false, false, descriptor_table_protodef_position_2fposition_2eproto, "position/position.proto", 558,
  &descriptor_table_position_2fposition_2eproto_once, descriptor_table_position_2fposition_2eproto_sccs, descriptor_table_position_2fposition_2eproto_deps, 1, 2,
  schemas, file_default_instances, TableStruct_position_2fposition_2eproto::offsets,
  file_level_metadata_position_2fposition_2eproto, 1, file_level_enum_descriptors_position_2fposition_2eproto, file_level_service_descriptors_position_2fposition_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_position_2fposition_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_position_2fposition_2eproto)), true);
namespace RoadPB {
...
void PositionObject::InitAsDefaultInstance() {
  ::RoadPB::_PositionObject_default_instance_._instance.get_mutable()->id_ = const_cast< ::RoadPB::FeatureID*>(
      ::RoadPB::FeatureID::internal_default_instance());
  ::RoadPB::_PositionObject_default_instance_._instance.get_mutable()->border_ = const_cast< ::RoadPB::Polygon*>(
      ::RoadPB::Polygon::internal_default_instance());
  ::RoadPB::_PositionObject_default_instance_._instance.get_mutable()->circle_ = const_cast< ::RoadPB::Circle*>(
      ::RoadPB::Circle::internal_default_instance());
  ::RoadPB::_PositionObject_default_instance_._instance.get_mutable()->pole_ = const_cast< ::RoadPB::Polyline*>(
...
void PositionObject::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_PositionObject_position_2fposition_2eproto.base);
  content_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void PositionObject::SharedDtor() {
...
const PositionObject& PositionObject::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_PositionObject_position_2fposition_2eproto.base);
...
void PositionObject::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:RoadPB.PositionObject)
  GOOGLE_DCHECK_NE(&from, this);
  const PositionObject* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PositionObject>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:RoadPB.PositionObject)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:RoadPB.PositionObject)
    MergeFrom(*source);
  }
}
...
void PositionObject::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:RoadPB.PositionObject)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
