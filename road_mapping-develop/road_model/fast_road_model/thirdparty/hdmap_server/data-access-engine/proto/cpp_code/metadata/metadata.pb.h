...
class FeatureID PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_metadata_2fmetadata_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  static inline bool FeatType_Parse(const std::string& name,
      FeatType* value) {
