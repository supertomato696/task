...
inline bool DiffState_Parse(
    const std::string& name, DiffState* value) {
...
class ErrorPoint PROTOBUF_FINAL :
 ...
 public:
  ...
  inline ErrorPoint* New() const final {
    return CreateMaybeMessage<ErrorPoint>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_dynamics_2fissue_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class Issue PROTOBUF_FINAL :
 ...
 public:
  ...
  inline Issue* New() const final {
    return CreateMaybeMessage<Issue>(nullptr);
  }
  ...
  void set_mark_red_editor(const std::string& value);
  void set_mark_red_editor(std::string&& value);
  void set_mark_red_editor(const char* value);
  void set_mark_red_editor(const char* value, size_t size);
  std::string* mutable_mark_red_editor();
  std::string* release_mark_red_editor();
  void set_allocated_mark_red_editor(std::string* mark_red_editor);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_mark_red_editor();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_mark_red_editor(
      std::string* mark_red_editor);
  private:
  const std::string& _internal_mark_red_editor() const;
  void _internal_set_mark_red_editor(const std::string& value);
  ...
  void set_mark_red_timestamp(const std::string& value);
  void set_mark_red_timestamp(std::string&& value);
  void set_mark_red_timestamp(const char* value);
  void set_mark_red_timestamp(const char* value, size_t size);
  std::string* mutable_mark_red_timestamp();
  std::string* release_mark_red_timestamp();
  void set_allocated_mark_red_timestamp(std::string* mark_red_timestamp);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_mark_red_timestamp();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_mark_red_timestamp(
      std::string* mark_red_timestamp);
  private:
  const std::string& _internal_mark_red_timestamp() const;
  void _internal_set_mark_red_timestamp(const std::string& value);
  ...
  void set_match_strategy(const std::string& value);
  void set_match_strategy(std::string&& value);
  void set_match_strategy(const char* value);
  void set_match_strategy(const char* value, size_t size);
  std::string* mutable_match_strategy();
  std::string* release_match_strategy();
  void set_allocated_match_strategy(std::string* match_strategy);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_match_strategy();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_match_strategy(
      std::string* match_strategy);
  private:
  const std::string& _internal_match_strategy() const;
  void _internal_set_match_strategy(const std::string& value);
  ...
  ::RoadPB::FeatureID* release_ref_id();
  ...
  ::RoadPB::FeatureID* release_tar_id();
  ...
  ::RoadPB::FeatureID* release_relate_id();
...
inline void Issue::set_desc(const std::string& value) {
...
inline void Issue::set_desc(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  desc_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RoadPB.Issue.desc)
}
inline void Issue::set_desc(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  desc_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RoadPB.Issue.desc)
}
inline void Issue::set_desc(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:RoadPB.Issue.desc)
}
...
inline std::string* Issue::unsafe_arena_release_desc() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RoadPB.Issue.desc)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return desc_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Issue::unsafe_arena_set_allocated_desc(
    std::string* desc) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (desc != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  desc_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      desc, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RoadPB.Issue.desc)
}
...
inline ::RoadPB::ErrorPoint* Issue::add_error_points() {
  ...
  return _internal_add_error_points();
}
...
inline void Issue::set_memo(const std::string& value) {
...
inline void Issue::set_memo(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  memo_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RoadPB.Issue.memo)
}
inline void Issue::set_memo(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  memo_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RoadPB.Issue.memo)
}
inline void Issue::set_memo(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  memo_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:RoadPB.Issue.memo)
}
...
inline std::string* Issue::unsafe_arena_release_memo() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RoadPB.Issue.memo)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return memo_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Issue::unsafe_arena_set_allocated_memo(
    std::string* memo) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (memo != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  memo_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      memo, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RoadPB.Issue.memo)
}
...
inline void Issue::clear_mark_red_qcid() {
  mark_red_qcid_ = PROTOBUF_LONGLONG(0);
...
inline void Issue::clear_mark_red_editor() {
  mark_red_editor_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  _has_bits_[0] &= ~0x00000004u;
}
...
inline void Issue::set_mark_red_editor(const std::string& value) {
  _internal_set_mark_red_editor(value);
...
inline std::string* Issue::mutable_mark_red_editor() {
  ...
  return _internal_mutable_mark_red_editor();
}
...
inline void Issue::_internal_set_mark_red_editor(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  mark_red_editor_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Issue::set_mark_red_editor(std::string&& value) {
  _has_bits_[0] |= 0x00000004u;
  mark_red_editor_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RoadPB.Issue.mark_red_editor)
}
inline void Issue::set_mark_red_editor(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  mark_red_editor_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RoadPB.Issue.mark_red_editor)
}
inline void Issue::set_mark_red_editor(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  mark_red_editor_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:RoadPB.Issue.mark_red_editor)
}
inline std::string* Issue::_internal_mutable_mark_red_editor() {
  _has_bits_[0] |= 0x00000004u;
  return mark_red_editor_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Issue::release_mark_red_editor() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return mark_red_editor_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* Issue::unsafe_arena_release_mark_red_editor() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RoadPB.Issue.mark_red_editor)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
  return mark_red_editor_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Issue::unsafe_arena_set_allocated_mark_red_editor(
    std::string* mark_red_editor) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (mark_red_editor != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  ...
  mark_red_editor_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      mark_red_editor, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RoadPB.Issue.mark_red_editor)
}
...
inline void Issue::clear_mark_red_timestamp() {
  mark_red_timestamp_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void Issue::set_mark_red_timestamp(const std::string& value) {
  _internal_set_mark_red_timestamp(value);
...
inline std::string* Issue::mutable_mark_red_timestamp() {
  ...
  return _internal_mutable_mark_red_timestamp();
}
...
inline void Issue::_internal_set_mark_red_timestamp(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  mark_red_timestamp_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Issue::set_mark_red_timestamp(std::string&& value) {
  _has_bits_[0] |= 0x00000008u;
  mark_red_timestamp_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RoadPB.Issue.mark_red_timestamp)
}
inline void Issue::set_mark_red_timestamp(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  mark_red_timestamp_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RoadPB.Issue.mark_red_timestamp)
}
inline void Issue::set_mark_red_timestamp(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000008u;
  mark_red_timestamp_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:RoadPB.Issue.mark_red_timestamp)
}
inline std::string* Issue::_internal_mutable_mark_red_timestamp() {
  _has_bits_[0] |= 0x00000008u;
  return mark_red_timestamp_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Issue::release_mark_red_timestamp() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  return mark_red_timestamp_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* Issue::unsafe_arena_release_mark_red_timestamp() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RoadPB.Issue.mark_red_timestamp)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000008u;
  return mark_red_timestamp_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Issue::unsafe_arena_set_allocated_mark_red_timestamp(
    std::string* mark_red_timestamp) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (mark_red_timestamp != nullptr) {
    _has_bits_[0] |= 0x00000008u;
  ...
  mark_red_timestamp_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      mark_red_timestamp, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RoadPB.Issue.mark_red_timestamp)
}
...
inline ::RoadPB::FeatureID* Issue::release_ref_id() {
  auto temp = unsafe_arena_release_ref_id();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline void Issue::set_allocated_ref_id(::RoadPB::FeatureID* ref_id) {
  ...
  if (ref_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(ref_id)->GetArena();
    if (message_arena != submessage_arena) {
...
inline ::RoadPB::FeatureID* Issue::release_tar_id() {
  auto temp = unsafe_arena_release_tar_id();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::RoadPB::FeatureID* Issue::mutable_tar_id() {
  ...
  return _internal_mutable_tar_id();
}
inline void Issue::set_allocated_tar_id(::RoadPB::FeatureID* tar_id) {
  ...
  if (tar_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(tar_id)->GetArena();
    if (message_arena != submessage_arena) {
...
inline void Issue::clear_match_strategy() {
  match_strategy_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void Issue::set_match_strategy(const std::string& value) {
  _internal_set_match_strategy(value);
...
inline std::string* Issue::mutable_match_strategy() {
  ...
  return _internal_mutable_match_strategy();
}
...
inline void Issue::_internal_set_match_strategy(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  match_strategy_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Issue::set_match_strategy(std::string&& value) {
  _has_bits_[0] |= 0x00000010u;
  match_strategy_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RoadPB.Issue.match_strategy)
}
inline void Issue::set_match_strategy(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  match_strategy_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RoadPB.Issue.match_strategy)
}
inline void Issue::set_match_strategy(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000010u;
  match_strategy_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:RoadPB.Issue.match_strategy)
}
inline std::string* Issue::_internal_mutable_match_strategy() {
  _has_bits_[0] |= 0x00000010u;
  return match_strategy_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Issue::release_match_strategy() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  return match_strategy_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* Issue::unsafe_arena_release_match_strategy() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RoadPB.Issue.match_strategy)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000010u;
  return match_strategy_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Issue::unsafe_arena_set_allocated_match_strategy(
    std::string* match_strategy) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (match_strategy != nullptr) {
    _has_bits_[0] |= 0x00000010u;
  ...
  match_strategy_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      match_strategy, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RoadPB.Issue.match_strategy)
}
...
inline void Issue::set_field_name(const std::string& value) {
...
inline void Issue::set_field_name(std::string&& value) {
  _has_bits_[0] |= 0x00000020u;
  field_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RoadPB.Issue.field_name)
}
inline void Issue::set_field_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000020u;
  field_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RoadPB.Issue.field_name)
}
inline void Issue::set_field_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000020u;
  field_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:RoadPB.Issue.field_name)
}
...
inline std::string* Issue::unsafe_arena_release_field_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RoadPB.Issue.field_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000020u;
  return field_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Issue::unsafe_arena_set_allocated_field_name(
    std::string* field_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (field_name != nullptr) {
    _has_bits_[0] |= 0x00000020u;
  ...
  field_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      field_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RoadPB.Issue.field_name)
}
...
inline ::RoadPB::FeatureID* Issue::release_relate_id() {
  auto temp = unsafe_arena_release_relate_id();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::RoadPB::FeatureID* Issue::mutable_relate_id() {
  ...
  return _internal_mutable_relate_id();
}
inline void Issue::set_allocated_relate_id(::RoadPB::FeatureID* relate_id) {
  ...
  if (relate_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(relate_id)->GetArena();
    if (message_arena != submessage_arena) {
