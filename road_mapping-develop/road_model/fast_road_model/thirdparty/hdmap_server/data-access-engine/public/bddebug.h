...
#ifndef _bd_abs
#define _bd_abs(a) (((a)>0)?(a):(-(a)))
#endif

#ifndef _bd_max
#define _bd_max(a,b) ((a)>(b)?(a):(b))
#endif

#ifndef  _bd_min
#define _bd_min(a,b) ((a)<(b)?(a):(b))
#endif
...
#ifndef MAKEINT64
#define MAKEINT64(a, b)			(__int64)((__int64(int((b))) << 32) | (__int64(int((a))) & 0x00000000FFFFFFFF)) 
#endif
#ifndef HIINT
#define HIINT(a)   (int((a) >> 32))
#endif
#ifndef LOINT
#define LOINT(a)   (int(a))
#endif
...
#endif
#ifndef DIB2RGB
#define DIB2RGB(dib) BGR2RGB(dib)
#endif

#ifndef BYTE0
#define BYTE0(value)      (LOBYTE((value)))
#endif
#ifndef BYTE1
#define BYTE1(value)      (LOBYTE((value) >> 8))
#endif
#ifndef BYTE2
#define BYTE2(value)      (LOBYTE((value) >> 16))
#endif
#ifndef BYTE3
#define BYTE3(value)      (LOBYTE((value) >> 24))
#endif
...
struct BDAR_LINE_NAME(ols_) { \
	...
	~BDAR_LINE_NAME(ols_)() { statement; } \
	void operator=( const BDAR_LINE_NAME(ols_)& ) {};\
