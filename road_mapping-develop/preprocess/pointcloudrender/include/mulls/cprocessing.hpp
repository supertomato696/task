...
namespace lo
{
    ...
    {
    public:
        bool ground_filter_pmf(const typename pcl::PointCloud<PointT>::Ptr &cloud,
                               typename pcl::PointCloud<PointT>::Ptr &gcloud,
                               typename pcl::PointCloud<PointT>::Ptr &ngcloud,
                               int max_window_size,
                               float slope,
        ...
        bool alpha_shape(const typename pcl::PointCloud<PointT>::Ptr &cloud,
                         float alpha_value,
        ...
        bool cornerpoint_knn(const typename pcl::PointCloud<PointT>::Ptr &boundary_cloud,
                             int K,
                             float disthreshold,
                             float maxcos,
        ...
        bool cornerpoint_rnn(const typename pcl::PointCloud<PointT>::Ptr &boundary_cloud,
                             ...
                             float disthreshold,
                             float maxcos,
                             typename pcl::PointCloud<PointT>::Ptr &corner_cloud) // Radius corner point extraction
        {
            pcl::KdTreeFLANN<PointT> kdtree;
            kdtree.setInputCloud(boundary_cloud);
