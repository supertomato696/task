        ...
        if os.path.isdir(cross_dir) and cross_dir_name.startswith("batch-"):
            ...
            for bag_dir_name in bag_dirs: 
                ...
                if os.path.isdir(bag_dir) and bag_dir_name.startswith("PL"):
                    ...
                    input_dir = os.path.join(raw_cross_dir, cross_dir_name, bag_dir_name) 
                    ...
                    src_files = {
                        ...
                        # # cover
                        # os.path.join(input_dir, "output.json") : os.path.join(output_dir, "source/data_engine/cover/output.json"),

                        # # match
                        # os.path.join(input_dir, "_mla_egopose_gps_matched.csv") : os.path.join(output_dir, "source/data_engine/match/{}/_mla_egopose_gps_matched.csv".format(bag_dir_name)),
                        # os.path.join(input_dir, "_mla_egopose_gps_matched.json") : os.path.join(output_dir, "source/data_engine/match/{}/_mla_egopose_gps_matched.json".format(bag_dir_name)),
                        # os.path.join(input_dir, "_sensor_gnss_rtk_gps_matched.csv") : os.path.join(output_dir, "source/data_engine/match/{}/_sensor_gnss_rtk_gps_matched.csv".format(bag_dir_name)),
                        # os.path.join(input_dir, "_sensor_gnss_rtk_gps_matched.json") : os.path.join(output_dir, "source/data_engine/match/{}/_sensor_gnss_rtk_gps_matched.json".format(bag_dir_name)),
                        # os.path.join(input_dir, "data_label.json") : os.path.join(output_dir, "source/data_engine/match/{}/data_label.json".format(bag_dir_name)),
                        # os.path.join(input_dir, "trail_match.json") : os.path.join(output_dir, "source/data_engine/match/{}/trail_match.json".format(bag_dir_name)),
                    }
