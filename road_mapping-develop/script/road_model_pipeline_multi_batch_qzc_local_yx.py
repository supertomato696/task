...
# 下面的是必须的
# default_workspace_folder = "/mnt/d/04_dataset/1_dilabel/crowd_source/raw_data_0224/new_10lukou"
# default_workspace_folder = "/mnt/d/04_dataset/1_dilabel/crowd_source/raw_data_0224/new_lidar_bev"
default_workspace_folder = "/mnt/e/01_code/02_dataset/crowd_source"
default_workspace_folder = "/mnt/e/01_code/02_dataset/crowd_source/raw_data_0605"  # test_data\9734_503604\9734_label_test\auto_label
# default_workspace_folder = "/mnt/d/01_code/02_dataset/crowd_source/jira_data"  # D:\01_code\02_dataset\crowd_source\jira_data
default_workspace_folder = "/mnt/e/01_code/02_dataset/crowd_source/test_data"  # test_data\9734_503604\9734_label_test\auto_label
# default_workspace_folder="/mnt/d/01_code/raw_data"
default_run_stage = 0 # 0:所有，1：拼图，2：矢量化，3：拓扑，4: 交通灯, 5:评测
...
default_debug_docker_tag="v" # debug: !!不允许为空!!!，这个变量会用来创建目录，生成各个版本的评估结果; release: 不需要
...
lukou_ids = {
    ...
    # "53323_label_prod/auto_label": [
    # ],
    # "53337_label_prod/auto_label": [
    # ],
    # "53343_label_prod/auto_label": [
    # ],
    # "53364_label_prod/auto_label": [
    # ],
    # "53523_label_prod/auto_label": [
    # ],
    # "53551_label_prod/auto_label": [
    # ],

    # "9718_label_test/auto_label": [
    # ],
    # "9711_label_test/auto_label": [
    # ],

    # "9733_503576/9733_label_test/auto_label": [  ###
    # ],
    # "9734_503604/9734_label_test/auto_label": [
    # ],
    "77611_label_prod/auto_label": [
    ],
